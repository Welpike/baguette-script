///=========================================================================
/// This module provides the EventSource (SSE) feature for baguette-script
/// Plugin from _hyperscript
///=========================================================================

/// <reference path="../bg-script.js" />
...
(function (self, factory) {
	...
	if (typeof exports === 'object' && typeof exports['nodeName'] !== 'string') {
		...
		if ('baguetteScript' in self) self._hyperscript.use(plugin)
	}
})(typeof self !== 'undefined' ? self : this, self => {
	/**
	 * @param {import("./bg-script.js").BaguetteScript} baguetteScript
	 */
	return baguetteScript => {
		baguetteScript.addFeature("eventsource", function (parser, runtime, tokens) {
