///=========================================================================
/// add translated WebGrammar commands
///=========================================================================
...
(function (self, factory) {
	...
	return (baguetteScript) => {
        ...
        baguetteScript.addCommand("regler", function (parser, runtime, tokens) {
            if (tokens.matchToken("regler")) {
        ...
        baguetteScript.addCommand("ajouter", function (parser, runtime, tokens) {
            if (tokens.matchToken("ajouter")) {
        ...
        baguetteScript.addCommand("enlever", function (parser, runtime, tokens) {
            if (tokens.matchToken("enlever")) {
                var classRef = parser.parseElement("classRef", tokens);
                var attributeRef = null;
        ...
        baguetteScript.addCommand("basculer", function (parser, runtime, tokens) {
            if (tokens.matchToken("basculer")) {
        ...
        baguetteScript.addCommand("cacher", function (parser, runtime, tokens) {
            if (tokens.matchToken("cacher")) {
        ...
        baguetteScript.addCommand("montrer", function (parser, runtime, tokens) {
            if (tokens.matchToken("montrer")) {
                var targetExpr = parseShowHideTarget(parser, runtime, tokens);
        ...
        baguetteScript.addCommand("prendre", function (parser, runtime, tokens) {
            if (tokens.matchToken("prendre")) {
                var classRef = parser.parseElement("classRef", tokens);
        ...
        baguetteScript.addCommand("mettre", function (parser, runtime, tokens) {
            if (tokens.matchToken("mettre")) {
        ...
        baguetteScript.addCommand("transition", function (parser, runtime, tokens) {
        ...
        baguetteScript.addCommand("mesurer", function (parser, runtime, tokens) {
            if (!tokens.matchToken("mesurer")) return;
        ...
        baguetteScript.addCommand("aller", function (parser, runtime, tokens) {
            if (tokens.matchToken("aller")) {
