///=========================================================================
/// implements templates for baguette-script
...
(function (self, factory) {
	...
	/**
	 * @param {BaguetteScriptObject} baguetteScript
	 */
	return baguetteScript => {
		...
		function renderTemplate(template, ctx) {
			...
			baguetteScript.evaluate(template, renderCtx);
			return buf.join("");
		}

		baguetteScript.addCommand("render", function (parser, runtime, tokens) {
		...
		baguetteScript.addLeafExpression("escape", function (parser, runtime, tokens) {
