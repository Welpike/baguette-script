/**
 * @typedef {Object} BaguetteScript
 */

(function (self, factory) {
    const baguetteScript = factory(self)

    if (typeof exports === 'object' && typeof exports['nodeName'] !== 'string') {
        module.exports = baguetteScript
    } else {
        self['baguetteScript'] = baguetteScript
        if ('document' in self) self['baguetteScript'].browserInit()
    }
    ...
    const config = {
        attributes: "_bg, script, data-script",
    ...
    class Parser {
        ...
        constructor(runtime) {
            ...
            /* ============================================================================================ */
            /* Core baguette-script Grammar Elements                                                            */
            /* ============================================================================================ */
         ...
         * @returns {ASTNode}
         */
        parseBaguetteScript(tokens) {
            var result = this.parseElement("baguette-script", tokens);  //
    ...
    class Runtime {
        ...
        constructor(lexer, parser) {
            ...
            this.parser = parser ?? new Parser(this)
                .use(baguetteScriptCoreGrammar)                  // some baguette-script specificities will be implemented here (soon ;))
                .use(baguetteScriptWebGrammar);                  //
        ...
        * locating baguette-script scripts in a DOM element.  If no value
        ...
        */
        getScript(elt) {
            ...
            if (elt instanceof HTMLScriptElement && elt.type === "text/bg-script") {
                return elt.innerText;
            }
            return null;
        }

        baguetteScriptFeaturesMap = new WeakMap

        /**
        * @param {*} elt
        * @returns {Object}
        */
        getBaguetteScriptFeatures(elt) {
            var baguetteScriptFeatures = this.baguetteScriptFeaturesMap.get(elt);
            if (typeof baguetteScriptFeatures === 'undefined') {
                if (elt) {
                    // in some rare cases, elt is null and this line crashes
                    this.baguetteScriptFeaturesMap.set(elt, baguetteScriptFeatures = {});
                }
            }
            return baguetteScriptFeatures;
        }
        ...
        */
        addFeatures(owner, ctx) {
            if (owner) {
                Object.assign(ctx.locals, this.getBaguetteScriptFeatures(owner));
        ...
        * @param {*} owner
        * @param {*} feature
        * @param {*} baguetteScriptTarget
        * @param {*} event
        * @returns {Context}
        */
        makeContext(owner, feature, baguetteScriptTarget, event) {
            return new Context(owner, feature, baguetteScriptTarget, event, this)
        }
        ...
        */
        parse(src) {
            ...
            if (this.parser.commandStart(tokens.currentToken())) {
                ...
                var baguetteScript = parser.requireElement("baguette-script", tokens);
                if (tokens.hasMore()) parser.raiseParseError(tokens);
        ...
        */
        evaluate(src, ctx, args) {
            class BaguetteScriptModule extends EventTarget {
                constructor(mod) {
                    super();
                    this.module = mod;
                }
            ...
            var body = 'document' in globalScope
                ...
                : new BaguetteScriptModule(args && args.module);
            ...
            if (element.execute) {
                ...
                return this.getBaguetteScriptFeatures(body);
            } else {
        ...
        */
        processNode(elt) {
            ...
            if (elt.querySelectorAll) {
                this.forEach(elt.querySelectorAll(selector + ", [type='text/bg-script']"), elt => {
                    this.initElement(elt, elt instanceof HTMLScriptElement && elt.type === "text/bg-script" ? document.body : elt);
                });
            }
        }
            ...
            if (!internalData.initialized) {
                ...
                if (src) {
                    try {
                        ...
                        const lexer = this.lexer, parser = this.parser
                        var tokens = lexer.tokenize(src);
                        var baguetteScript = parser.parseBaguetteScript(tokens);
                        if (!baguetteScript) return;
                        baguetteScript.apply(target || elt, elt);
                        setTimeout(() => {
                        ...
                        console.error(
                            "baguette-script errors were found on the following element:",
                            elt,
                            "\n\n",
                            e.message,
                            e.stack
        ...
        * @returns {boolean}
        */
        isBaguetteScriptContext(context) {
        ...
        */
        resolveSymbol(str, context, type) {
            ...
            if (str === "you" || str === "your" || str === "yourself") {
                ...
                if (type === "global") {
                    ...
                    if (this.isBaguetteScriptContext(context) && !this.isReservedWord(str)) {
                        // local scope
        ...
        setSymbol(str, context, type, value) {
            if (type === "global") {
                ...
                if (this.isBaguetteScriptContext(context) && !this.isReservedWord(str) && typeof context.locals[str] !== "undefined") {
                    // local scope
                    context.locals[str] = value;
                } else {
                    // element scope
        ...
        */
        assignToNamespace(elt, nameSpace, name, value) {
            ...
            if (typeof document !== "undefined" && elt === document.body) {
                ...
                root = this.getBaguetteScriptFeatures(elt);
            }
            var propertyName;
        ...
        */
        ...
        /** @type string | null */
        // @ts-ignore
        baguetteScriptUrl = "document" in globalScope && document.currentScript ? document.currentScript.src : null;
    }
    ...
    class Context {
        ...
        * @param {*} event
        */
        constructor(owner, feature, baguetteScriptTarget, event, runtime) {
            this.meta = {
     ...
     * @param {Parser} parser
     */
    function baguetteScriptCoreGrammar(parser) {
        ...
        //        (NB: we do not support `in` dues to conflicts w/ the baguette-script grammar)
        ...
        parser.addGrammarElement("beepExpression", function (parser, runtime, tokens) {
            ...
            if (expression) {
                ...
                expression.evaluate = function(ctx){
                    ...
                    let element = ctx.me;
                    if (runtime.triggerEvent(element, "baguette-script:beep", {element, expression, value})) {
                        var typeName;
                        if (value) {
        ...
        parser.addGrammarElement("baguette-script", function (parser, runtime, tokens) {
            var features = [];
                    ...
                    for (const eventSpec of onFeature.events) {
                        ...
                        runtime.implicitLoop(targets, function (target) {
                            ...
                            if (eventSpec.mutationSpec) {
                                eventName = "baguette-script:mutation";
                            ...
                            if (eventSpec.intersectionSpec) {
                                eventName = "baguette-script:intersection";
        ...
        parser.addFeature("behavior", function (parser, runtime, tokens) {
            ...
            var hs = parser.requireElement("baguette-script", tokens);
        ...
        parser.addCommand("fetch", function (parser, runtime, tokens) {
            ...
            var fetchCmd = {
                ...
                op: function (context, url, args) {
                    ...
                    runtime.triggerEvent(context.me, "baguette-script:beforeFetch", detail);
    ...
    function baguetteScriptWebGrammar(parser) {
    ...
    function browserInit() {
        ...
        var scripts = Array.from(globalScope.document.querySelectorAll("script[type='text/bg-script'][src]"))
        Promise.all(
        ...
        .then(script_values => script_values.forEach(sc => baguetteScript(sc)))
        .then(() => ready(function () {
            mergeMetaConfig();
    ...
    /**
     * @typedef {Object} BaguetteScriptAPI
     *
     ...
     *
     *
     * @typedef {BaguetteScriptAPI & ((src: string, ctx?: Partial<Context>) => any)} BaguetteScript
     */

    /**
     * @type {BaguetteScript}
     */
    const baguetteScript = Object.assign(
        run,
        {
            config,

            use(plugin) { plugin(baguetteScript) },
